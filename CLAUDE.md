...
All managed docs share **one `version`** (currently **1.11.0**) and carry YAML frontmatter. App version (`1.0.7` (shipped 2026-06-01)) is tracked separately via `app-version`. *(There is also a non-managed design reference, `docs/F-02-online-vault-design.md`, with no shared version.)*
